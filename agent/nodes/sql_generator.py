...
class SQLGenerator:
    ...
    def generate_sql(self, intent_analysis: dict[str, Any], classification_result: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            prompt = ChatPromptTemplate.from_messages([
                ("system", f"""You are a SQL expert. Generate ONE complete executable SQL statement.
...
Return ONLY the SQL statement, nothing else."""),
                ("human", f"Generate SQL for: {intent_analysis.get('original_query', '')}")
            ])
